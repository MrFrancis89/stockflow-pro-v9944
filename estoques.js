...
function _acao_excluir() {
    ...
    mostrarConfirmacao(
        ...
        () => {
            // excluirEstoque() já troca o ativo para o próximo se necessário
            excluirEstoque(ativoId);
            // Após excluir, o novo ativo já foi definido por excluirEstoque()
            // Passa explicitamente para evitar race condition
            const novoAtivo = appStore.get('estoqueAtivoId') || carregarEstoqueAtivoId();
