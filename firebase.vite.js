...
const FIREBASE_CONFIG = {
    // ⚠️  SEGURANÇA: para produção, substitua os valores literais por variáveis
    // de ambiente Vite (ex.: import.meta.env.VITE_FIREBASE_API_KEY).
    // Consulte .env.example para instruções de configuração.
