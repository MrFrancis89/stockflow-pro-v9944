...
const FIREBASE_CONFIG = {
    // ⚠️  SEGURANÇA: estas credenciais estão hardcoded para compatibilidade com
    // o modo de desenvolvimento sem Vite (servir arquivos estáticos diretamente).
    // Para produção com Vite, substitua pelos valores de import.meta.env.*
    // conforme documentado em .env.example.
    // A apiKey do Firebase para web é projetada para ser pública; a segurança
    // real é garantida pelas Firebase Security Rules no console do Firebase.
    // Garanta que .gitignore esteja configurado antes de publicar o repositório.
